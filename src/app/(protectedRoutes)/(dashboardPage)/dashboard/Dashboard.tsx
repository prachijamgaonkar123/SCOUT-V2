...
const STATUS_META: Record<string, { name: string; value: number }> = {
  SUC001: { name: "PPE Detection (Helmet, Vest, Gloves, Mask)", value: 3 },
  SUC002: { name: "Fire and Smoke Detection", value: 8 },
  SUC003: { name: "Fall Detection", value: 9 },
  SUC004: { name: "Forklift / Vehicle in Walkways", value: 3 },
  SUC005: { name: "Emergency Exit Blockage Detection", value: 5 },
  SUC006: { name: "Crowd Detection in Hazardous Zones", value: 5 },
  SUC007: { name: "Intrusion Detection at Perimeter", value: 4 },
  SUC010: { name: "Movement During Shutdown Hours", value: 14 },
  SUC008: { name: "Unauthorized Access in Restricted Areas", value: 8 },
  SUC009: { name: "Camera Tampering Detection", value: 3 },
  SUC016: { name: "People Count in Factory Premises", value: 25 },
  SUC017: { name: "Vehicle Count & ANPR at Gates", value: 6 },
  SUC018: { name: "Canteen Usage Monitoring", value: 165 },
  SUC019: { name: "Vehicle Unloading / Loading Monitoring", value: 2 },
  SUC020: { name: "Unauthorized Parking / Blocking Aisles", value: 4 },
  SUC013: { name: "Employee Idle Time Monitoring", value: 3 },
  SUC011: { name: "Employee Presence in Critical Areas", value: 3  },
